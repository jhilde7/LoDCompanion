...
namespace LoDCompanion.Models.Character
{
    ...
    public class MonsterWeapon
    {
        ...
        public int ReloadTime { get; set; } // Might be more relevant for ranged, but kept for direct conversion

        // Boolean flags describing weapon properties
        public bool IsFast { get; set; }
        public bool IsSlow { get; set; }
        public bool IsBFO { get; set; } // Assuming "Big, Fast Object" or similar
        public bool IsStun { get; set; }
        public bool IsDefensive { get; set; }
        public bool IsUnwieldly { get; set; }
        public bool IsStealthly { get; set; } // Retaining original spelling
        public bool IsReach { get; set; }
        public bool IsEnsnare { get; set; }
        public bool IsRanged { get; set; } // Indicates if the weapon is ranged

        // Default constructor for potential deserialization or default initialization
        public MonsterWeapon()
        {
            // Initialize properties to default values
            DamageArray[0] = 0; // Min damage
            DamageArray[1] = 0; // Max damage
            ArmourPiercing = 0;
            ReloadTime = 0;
            IsFast = false;
            IsSlow = false;
        ...
        // Constructor to easily set initial damage values
        public MonsterWeapon(int minDamage, int maxDamage) : this() // Call default constructor for other initializations
        {
            DamageArray[0] = minDamage; // Set minimum damage
            DamageArray[1] = maxDamage; // Set maximum damage
        }

        /// <summary>
        /// Calculates the total damage for this weapon, including a bonus.
        /// </summary>
        /// <param name="damageBonus">An additional bonus to be added to the damage roll.</param>
        /// <returns>The total damage dealt by the weapon after a random roll and bonus.</returns>
        public int GetDamage(int damageBonus)
        {
            // Use RandomHelper for random number generation.
            ...
            // To include MaxDamage, we pass MaxDamage + 1.
            int rolledDamage = RandomHelper.GetRandomNumber(DamageArray[0], DamageArray[1]);
            return rolledDamage + damageBonus;
        }
    }
}
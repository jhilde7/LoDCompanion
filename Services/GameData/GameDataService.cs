...
namespace LoDCompanion.Services.GameData
{
    public class GameDataService
    {
        ...
        public Talent GetRandomTalentByCategory(string? category = null)
        {
            switch (category)
            {
                case "Physical":
                ...
                default:
                    ...
                    return allList[RandomHelper.GetRandomNumber(0, allList.Count - 1)];
            }
        }
        ...
        private static readonly Dictionary<string, string> TooltipDictionary = new Dictionary<string, string>(System.StringComparer.OrdinalIgnoreCase)
    {
        ...
        { "CON", "Constitution (CON): Symbolises how fit your hero is and how well they can withstand diseases and poison. A high constitution also allows the hero to take more damage." },
        { "DEX", "Dexterity (DEX): Represents how dexterous your hero is. The more dexterous, the more likely they will dodge an incoming strike or jump across a chasm." },
        { "WIS", "Wisdom (WIS): Governs your abilities to analyse things, and is also important for dealing with Magic and Alchemy. A wizard's Mana is equal to their Wisdom." },
        { "RES", "Resolve (RES): This is the mental strength of your character and a measure of how well they can handle fear. It also symbolises their faith in the gods." },

    ...
    public class TreasureService
    {
        ...
        public async Task<Equipment?> GetFineTreasureAsync()
        {
            ...
            switch (roll)
            {
                ...
                case 43:
                case 44:
                    roll = await _diceRoll.RequestRollAsync($"You found a weapon!", "1d8");
        ...
        public async Task<Equipment?> GetWonderfulTreasureAsync()
        {
            ...
            switch (roll)
            {
                ...
                case 38:
                    ...
                    break;
                case 39:
                    treasure = EquipmentService.GetShieldByNameSetDurability("Mithril Heater Shield", armourDurability);
                    break;
                case 40:
                case 41:
                case 42:

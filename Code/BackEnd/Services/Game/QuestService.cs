...
namespace LoDCompanion.Code.BackEnd.Services.Game
{
    ...
    public class Quest
    {
        ...
        public List<RoomInfo>? RoomsToInclude { get; set; }
    ...
    public class QuestService
    {
        ...
        public List<Quest> StandaloneQuests { get; private set; } = new();
        ...
        {
            if (Campaigns.Any() && StandaloneQuests.Any()) return;
                ...
                "This campaign starts wherever the heroes are, but the second quest must be started in Silver City.")
                {
                    Quests = new List<Quest>
                    {
                        ...
                        new Quest()
                        {
                            ...
                            QuestOrigin = SettlementName.SilverCity,
                            StartingRoom = _room.GetRoomByName("Start Tile"),
                            ...
                            RoomsToInclude = new() 
                                {
                                    new RoomInfo(){
                                        ...
                                        Size = [ 6, 6 ],
                                        FurnitureList = [
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(2, 0, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(3, 0, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(2, 1, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(3, 1, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(0, 2, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(1, 2, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(2, 2, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(3, 2, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(4, 2, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(5, 2, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(0, 3, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(1, 3, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(2, 3, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(3, 3, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(4, 3, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(5, 3, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(0, 4, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(1, 4, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(2, 4, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(3, 4, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(4, 4, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(5, 4, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(0, 5, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Chest", new List<GridPosition>() { new GridPosition(1, 5, 0)}),
                                            new Chest()
                                            {
                                            ...
                                            SearchService.GetFurnitureByNameSetPosition("Chest", new List<GridPosition>() { new GridPosition(4, 5, 0)}),
                                            SearchService.GetFurnitureByNameSetPosition("Floor", new List<GridPosition>() { new GridPosition(5, 5, 0)}),
                                            ]
                                    }
                                },
                            RewardCoin = 2000,
        ...
        {
            return StandaloneQuests.FirstOrDefault(q => q.Name == name);
        }
